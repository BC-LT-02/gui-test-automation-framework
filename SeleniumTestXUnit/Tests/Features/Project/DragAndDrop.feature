Feature: Project drag and drop actions
    ...
    Scenario: Change the order of a project on the list
        When the user drags and drop a project under another project of the list
        Then the project should be displayed in the new location
